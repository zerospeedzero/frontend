...
const EventForm = ({ onClose }) => {
  ...
  return (
  <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center overflow-scroll">
      <form className="container mx-auto mt-8 bg-white p-8 max-w-xl" onSubmit={(e)=>handleSubmit(e)}>
